...
(function(factory) {
    ...
    // addMethod("fechaHasta", function(value, element, params) {
    ...
    Fuente: https: //www.iteramos.com/pregunta/18842/fecha-de-finalizacion-superior-fecha---validacion-de-jquery
        // Ajax mode: abort
...
jQuery.validator.addMethod("fechaFin", function(value, element, params) {
        if (!/Invalid|NaN/.test(new Date(value))) {
            return new Date(value) >= new Date($(params).val());
        }
        return isNaN(value) && isNaN($(params).val()) || (Number(value) >= Number($(params).val()));
    }, 'Selecione una fecha mayor que la inicial.')
