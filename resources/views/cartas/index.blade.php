...
<html lang="es" class="no-js">
  <head>
    ...
    <script>
      ...
      link.rel = 'stylesheet';
      link.id='modo'
      link.href = localStorage.getItem("selectedTheme") || "{{ $ninio->genero=='Male'?asset('cartas/css/main.css'):asset('cartas/css/main-mujer.css') }}";
            ...
            <header id="site_header" class="header mobile-menu-hide">
              <div class="header-content">
                ...
                <div class="header-photo">
                  <img src="{{$ninio->genero=='Male'? asset('cartas/img/hombre.png'): asset('cartas/img/mujer.png') }}" alt="{{ $ninio->nombres }}">
                </div>
                      ...
                      $(function () {
                        $("#switch-id").change(function () {
                            ...
                            if ($(this).is(":checked")) {
                              ...
                              localStorage.setItem("selectedTheme", "{{ $ninio->genero=='Male'?asset('cartas/css/main.css'):asset('cartas/css/main-mujer.css') }}");
                            }
              ...
              <div class="copyrights">
                <span>Diseñado y desarrollado por <a href="https://www.persontechnology.com/" class="text-light" target="_blanck">Person Technology</a></span>
                      ...
                      <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                          ...
                          <div class="title-block">
                            ...
                            <span class="text-primary">Con tu aporte damos valor al futuro de miles de niñas y niños.</span>
                            <br>
                            <a href="{{ asset('cartas/img/cactu-cartas-manual-web.mp4') }}" target="_blanck" class="btn btn-primary">Ver manual</a>
                        ...
                        <div class="fw-pricing clearfix row">
                          ...
                          @foreach ($buzones as $buzon)
                              <div class="fw-package-wrap col-md-6 highlight-col">
                                  ...
                                  <p>
                                      <span class="lnr lnr-envelope"></span><strong><sup>{{ $buzon->buzonCartasNinio->count() }}</sup></strong>
                                      <small>del:</small> <strong>{{ \Carbon\Carbon::parse($buzon->fecha)->format('M/d/Y')}}</strong>
                                      <small>sin contestar</small>
                                  </p>
                                  
                                  <div class="fw-button-row">
                                      @foreach ($buzon->buzonCartasNinio as $carta)
                                      <button role="link" onclick="cargarPagina('{{route('misCartasRespuestas',[Crypt::encryptString($carta->cartasBuzon->id),Crypt::encryptString($buzon->ninio->token)])}}')" type="button" class="btn btn-secondary">
                                          {{$carta->nombre}}
                                      </button><br>
                                      @endforeach
                                  </div>
                  ...
                  <div class="section-content">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-8">
                        ...
                        <p><strong>CHILDFUND</strong>, Trabajamos para que niñas, niños y adolescentes logren un desarrollo integral en espacios seguros y sin violencia. Impactamos positivamente su vida y su entorno.</p>
                        </div>
                        <div>
                          <img src="{{ asset('img/cactu-logo.jpeg') }}" class="img-fluid" alt="">
                          <p> <strong>CACTU</strong>, es una organización comunitaria que aporta por un futuro mejor , porque en ese lugar es donde vamos a vivir ...</p>
                        </div>
