...
@section('breadcrumbs', Breadcrumbs::render('importarModulo'))

@section('content')

<form method="POST" action="{{ route('procesarImportacionModulo') }}" enctype="multipart/form-data">
    @csrf
    <div class="card">
        ...
        <div class="card-footer text-muted">
            <button type="submit" class="btn btn-primary">Importar Módulos <i class="icon-paperplane ml-2"></i></button>
        </div>
    </div>
</form>
