...
@section('breadcrumbs', Breadcrumbs::render('importarActividad'))

@section('content')

<form method="POST" action="{{ route('procesarImportacionActividad') }}" enctype="multipart/form-data">
    @csrf
    <div class="card">
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <th scope="row">Socialización del programa con las comunidades </th>
                        <td>IA111-01</td>                        
                    </tr>
                </table>
            </div>
        ...
        <div class="card-footer text-muted">
            <button type="submit" class="btn btn-primary">Importar actividades <i class="icon-paperplane ml-2"></i></button>
        </div>
    </div>
</form>
