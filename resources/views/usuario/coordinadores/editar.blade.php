@extends('layouts.app',['title'=>'Actualizar coordinador'])

@section('breadcrumbs', Breadcrumbs::render('editarCoordinador',$usuario))



@section('content')
<form method="POST" action="{{ route('actualizarCoordinador') }}">
    @csrf
