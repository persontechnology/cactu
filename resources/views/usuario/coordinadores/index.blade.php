@extends('layouts.app',['title'=>'Coordinadores'])

@section('breadcrumbs', Breadcrumbs::render('coordinadores'))

@section('barraLateral')

    <div class="breadcrumb justify-content-center">
        <a href="{{ route('coordinadoresNuevo') }}" class="breadcrumb-elements-item">
...
@prepend('linksPie')
    <script>
        ...
        function eliminar(arg){
            var url="{{ route('eliminarCoordinador') }}";
            var id=$(arg).data('id');
            swal({
                title: "¿Estás seguro?",
