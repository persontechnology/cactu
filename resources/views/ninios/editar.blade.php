...
@section('breadcrumbs', Breadcrumbs::render('editarNinio',$ninio))
@section('content')
<form action="{{route('actualizar-ninio')}}" method="post">
	@csrf
<div class="card">
		...
		<div class="row">
			<div class="col-sm-6">
				...
				<div class="form-group row " id="ninioNumero">
					<label class="col-form-label col-lg-3">Número de participante </label>
					<div class="col-lg-9">
