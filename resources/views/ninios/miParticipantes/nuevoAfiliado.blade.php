...
@section('breadcrumbs', Breadcrumbs::render('nuevoMiParticipante',$tipoParticipante))

@section('content')

<form action="{{route('guardarMiParticipanteAfiliado')}}" method="post">
	@csrf
	<div class="card">
			...
			<div class="row">
				<div class="col-sm-6">
					...
					<div class="form-group row">
						...
						<div class="col-lg-9">
							<input type="tel"  id="celular" name="celular" value="{{ old('celular') }}" class="form-control @error('celular') is-invalid @enderror" >
							@error('celular')
								<span class="invalid-feedback" role="alert">
									<strong>{{ $message }}</strong>
								</span>
