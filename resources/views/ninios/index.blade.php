@extends('layouts.app',['title'=>'Participantes'])
@section('breadcrumbs', Breadcrumbs::render('ninios'))
@section('barraLateral')
    ...
    <div class="breadcrumb justify-content-center">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                @if($tipoParticipante->count()>0)
                    @foreach($tipoParticipante as $tipo)
                        ...
                        <a href="{{route('nuevo-ninio',$tipo->id)}}" class="dropdown-item">
        ...
        <a href="{{route('subir-ninios')}}" class="breadcrumb-elements-item">
            <i class="icon-upload mr-2"></i>Subir participantes
         </a>
        @endrole  
        ...
        <div class="breadcrumb-elements-item dropdown p-0">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                    <a href="{{ route('qrsNinioPdfDescargar') }}" class="dropdown-item"><i class="fas fa-file-pdf"></i> Descargar Códigos Qrs</a>
 ...
 {!! $dataTable->scripts() !!}
   <script type="text/javascript">
            ...
            function(){
                ...
                $.post( "{{ route('eliminar-ninio') }}", { ninio: id })
                .done(function( data ) {
                    if(data.success){
