@extends('layouts.app',['title'=>'Nuevo Material.'])
@section('breadcrumbs', Breadcrumbs::render('nuevoMaterial'))
@section('content')
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <div class="input-group mb-3">
                        ...
                        <input type="number"  placeholder="0.00" min="0" pattern="^\d+(?:\.\d{1,2})?$" step="0.01" id="precio" name="precio" value="{{ old('precio') }}" class="form-control @error('precio') is-invalid @enderror" >
                        @error('precio')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <div class="input-group mb-3">                       
                        ...
                        <input type="number" placeholder="0.00" min="0" pattern="^\d+(?:\.\d{1,2})?$" step="0.01"  id="iva" name="iva" value="{{ old('iva') }}" class="form-control @error('iva') is-invalid @enderror" >
