...
@section('breadcrumbs', Breadcrumbs::render('familiaNinios',$ninio))

@section('content')

<form action="{{route('guardar-familia')}}" method="post">
    @csrf
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="form-group row">
                        <label class="col-form-label text-right col-lg-3">Representante<span class="text-danger">*</span></label>
                        <div class="col-lg-9">
                            <div class="input-group">
                                <span class="input-group-prepend">
                                    <span class="input-group-text"><i class="icon-user"></i></span>
                                </span>
                                <input type="text" value="{{ isset($ninio->familia->otro1) ? $ninio->familia->otro1 : '' }}"  name="otro1" id="otro1" class="form-control" placeholder="Ingrese Representante">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label text-right col-lg-3">N° Celular<span class="text-danger">*</span></label>
                        <div class="col-lg-9">
                            <div class="input-group">
                                <span class="input-group-prepend">
                                    <span class="input-group-text"><i class="icon-iphone"></i></span>
                                </span>
                                <input type="tel" value="{{ isset($ninio->familia->otro2) ? $ninio->familia->otro2 : '' }}" name="otro2" id="otro2" class="form-control" placeholder="Ingrese celular" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label text-right col-lg-3">E-mail<span class="text-danger">*</span></label>
                        <div class="col-lg-9">
                            <div class="input-group">
                                <span class="input-group-prepend">
                                    <span class="input-group-text"><i class="icon-envelope"></i></span>
                                </span>
                                <input type="email" value="{{ isset($ninio->familia->otro3) ? $ninio->familia->otro3 : '' }}" name="otro3" id="otro3" class="form-control" placeholder="Ingrese email" required>
                            </div>
                        </div>
                    </div>
                    {{--  <div class="form-group row">
